            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                        <x-dropdown-link :href="route('admin.tenants.index')">Tenants</x-dropdown-link>
                        <x-dropdown-link :href="route('admin.mypackages.index')">Packages</x-dropdown-link>
                        <x-dropdown-link :href="route('admin.categories.index')">Hostel Category</x-dropdown-link>
